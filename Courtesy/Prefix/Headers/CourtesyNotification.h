...
#ifndef CourtesyNotification_h
#define CourtesyNotification_h

// 状态栏推送条相关
#define kStatusBarNotificationTime 2.0
...
#define kCourtesyActionScanRestartCapture @"kCourtesyActionScanRestartCapture"

#define kCourtesyCardComposeQueueUpdated @"kCourtesyCardComposeQueueUpdated"
#define kCourtesyCardStatusUpdated @"kCourtesyCardStatusUpdated"
