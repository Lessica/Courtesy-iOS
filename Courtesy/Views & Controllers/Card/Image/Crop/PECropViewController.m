...
@interface PECropViewController () <UIActionSheetDelegate, LGAlertViewDelegate>
...
{
    LGAlertView *alertView = [[LGAlertView alloc] initWithTitle:@"设定约束"
                                                        message:@"裁剪区域将重置为约束比例"
...
- (void)alertView:(LGAlertView *)alertView buttonPressedWithTitle:(NSString *)title index:(NSUInteger)buttonIndex {
    if (buttonIndex == 0) {
